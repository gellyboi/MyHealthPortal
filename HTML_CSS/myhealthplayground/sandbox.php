...
//========== Database Connection ==========
$conn = new mysqli($servername, $username, "", "db1", $sqlport, "/vols/sdb7/httpdh3_db/httpdh3_db.sock");
...
if(isset($_POST['submit']))
{
  ...
  $conn = new mysqli($servername, $username, "", $targetDB, $sqlport, "/vols/sdb7/httpdh3_db/httpdh3_db.sock");
  // Check connection
  if ($conn->connect_error) {
