...
INSERT INTO `Products` (`PrescriptionID`, `PrescriptionName`, `Amount`, `Cost`)
VALUES
        (500000001, 'Abacavir Sulfate', 50, '98'),
        (500000002, 'Abarelix', 60, '38'),
        (500000003, 'Abatacept', 30, '53'),
        (500000004, 'Acetaminophen', 20, '61'),
        (500000005, 'Adderall', 30, '117'),
        (500000006, 'Amitriptyline', 40, '61'),
        (500000007, 'Amlodipine', 50, '91'),
        (500000008, 'Amoxicillin', 50, '101'),
        (500000009, 'Ativan', 60, '58'),
        (500000010, 'Atorvastatin', 30, '101'),
        (500000011, 'Azithromycin', 30, '114'),
        (500000012, 'Benzonatate', 60, '64'),
        (500000013, 'Brilinta', 50, '132'),
        (500000014, 'Calan', 50, '139'),
        (500000015, 'Calciferol', 60, '49'),
        (500000016, 'Cephalexin', 40, '77'),
        (500000017, 'Ciprofloxacin', 30, '94'),
        (500000018, 'Citalopram', 30, '59'),
        (500000019, 'Clindamycin', 20, '45'),
        (500000020, 'Clonazepam', 40, '52'),
        (500000021, 'Cyclobenzaprine', 20, '60'),
        (500000022, 'Cymbalta', 60, '134'),
        (500000023, 'Doxycycline', 30, '29'),
        (500000024, 'Dupixent', 40, '131'),
        (500000025, 'Entresto', 60, '66'),
        (500000026, 'Entyvio', 40, '119'),
        (500000027, 'Fabrazyme', 60, '115'),
        (500000028, 'Factive', 50, '57'),
        (500000029, 'Factrel', 60, '54'),
        (500000030, 'Famciclovir', 30, '139'),
        (500000031, 'Famotidine', 60, '61'),
        (500000032, 'Famvir', 60, '34'),
        (500000033, 'Fanapt', 60, '90'),
        (500000034, 'Fansidar', 20, '36'),
        (500000035, 'Farxiga', 20, '131'),
        (500000036, 'Fentanyl', 30, '41'),
        (500000037, 'Fentanyl Patch', 50, '90'),
        (500000038, 'Gabapentin', 50, '82'),
        (500000039, 'Gilenya', 50, '105'),
        (500000040, 'Humira', 20, '68'),
        (500000041, 'Hydrochlorothiazide', 50, '39'),
        (500000042, 'Hydroxychloroquine', 50, '67'),
        (500000043, 'Ibuprofen', 60, '75'),
        (500000044, 'Imbruvica', 50, '101'),
        (500000045, 'Invokana', 50, '140'),
        (500000046, 'Januvia', 40, '39'),
        (500000047, 'Jardiance', 30, '63'),
        (500000048, 'Kevzara', 20, '111'),
        (500000049, 'Lexapro', 40, '106'),
        (500000050, 'Lisinopril', 50, '39'),
        (500000051, 'Loratadine', 50, '77'),
        (500000052, 'Lyrica', 40, '47'),
        (500000053, 'Macrobid', 40, '74'),
        (500000054, 'Macrodantin', 60, '96'),
        (500000055, 'Macugen', 60, '109'),
        (500000056, 'Mafenide Acetate', 40, '56'),
        (500000057, 'Magnesium Sulfate', 50, '123'),
        (500000058, 'Magnevist', 60, '131'),
        (500000059, 'Malarone', 40, '121'),
        (500000060, 'Malathion', 20, '87'),
        (500000061, 'Mandol', 60, '38'),
        (500000062, 'Mangafodipir', 20, '51'),
        (500000063, 'Mannitol', 20, '60'),
        (500000064, 'Melatonin', 50, '122'),
        (500000065, 'Meloxicam', 60, '39'),
        (500000066, 'Metformin', 20, '43'),
        (500000067, 'Methadone', 60, '49'),
        (500000068, 'Methotrexate', 30, '120'),
        (500000069, 'Metoprolol', 60, '65'),
        (500000070, 'Naproxen', 30, '107'),
        (500000071, 'Omeprazole', 40, '62'),
        (500000072, 'Onpattro', 60, '39'),
        (500000073, 'Otezla', 30, '35'),
        (500000074, 'Ozempic', 50, '109'),
        (500000075, 'Paclitaxel', 20, '113'),
        (500000076, 'Palifermin', 60, '48'),
        (500000077, 'Paliperidone', 20, '29'),
        (500000078, 'Palivizumab', 60, '139'),
        (500000079, 'Palonosetron', 50, '61'),
        (500000080, 'Palonosetron hydrochloride', 60, '119'),
        (500000081, 'Pamelor', 30, '27'),
        (500000082, 'Pamidronate Disodium', 40, '71'),
        (500000083, 'Pancrecarb', 40, '120'),
        (500000084, 'Pancrelipase', 40, '33'),
        (500000085, 'Pandel', 40, '103'),
        (500000086, 'Panhematin', 30, '53'),
        (500000087, 'Panretin', 40, '115'),
        (500000088, 'Pantoprazole', 50, '70'),
        (500000089, 'Prednisone', 20, '127'),
        (500000090, 'Rasagiline', 60, '68'),
        (500000091, 'Rasburicase', 20, '114'),
        (500000092, 'Raxar', 60, '137'),
        (500000093, 'Rebetol', 50, '33'),
        (500000094, 'Rebetron', 40, '122'),
        (500000095, 'Rebif', 30, '112'),
        (500000096, 'Reclast', 20, '85'),
        (500000097, 'Recombinate', 50, '103'),
        (500000098, 'Refacto', 40, '70'),
        (500000099, 'Refludan', 30, '43'),
        (500000100, 'Regadenoson', 20, '120'),
        (500000101, 'Reglan', 20, '122'),
        (500000102, 'Regranex', 60, '69'),
        (500000103, 'Relafen', 30, '138'),
        (500000104, 'Rybelsus', 20, '29'),
        (500000105, 'Taclonex', 40, '131'),
        (500000106, 'Tacrine', 60, '102'),
        (500000107, 'Tacrolimus', 50, '66'),
        (500000108, 'Tadalafil', 60, '128'),
        (500000109, 'Tagamet', 20, '35'),
        (500000110, 'Talacen', 20, '49'),
        (500000111, 'Talwin', 40, '35'),
        (500000112, 'Tramadol', 20, '83'),
        (500000113, 'Trazodone', 60, '135'),
        (500000114, 'Viagra', 40, '106'),
        (500000115, 'Wellbutrin', 40, '115'),
        (500000116, 'Xanax', 20, '76');
